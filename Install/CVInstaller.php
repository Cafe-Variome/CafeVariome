...
class CVInstaller
{
	public static function InstallDB()
	{
	   ...
	   */
	   ...
	   $con->query("Update settings set value = '$installation_key' where name = 'Installation Key';");
	   $con->query("Update settings set value = '$auth_server' where name = 'Authorization Server URL';");
