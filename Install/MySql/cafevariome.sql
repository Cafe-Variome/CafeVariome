...
--
-- Host: localhost:3306
-- Generation Time: Apr 07, 2022 at 04:20 PM
...
INSERT INTO `settings` (`setting_id`, `setting_key`, `value`, `setting_name`, `info`, `setting_group`, `validation_rules`) VALUES
                                                                                                                               ...
                                                                                                                               (23, 'hpo_autocomplete_url', 'https://autocomplete.cafevariome.org/Hpo/query/', 'HPO Auto-complete Endpoint', 'Endpoint that provides auto-complete service for HPO terms lookup ', 'endpoint', 'required'),
                                                                                                                               (24, 'orpha_autocomplete_url', 'https://autocomplete.cafevariome.org/Orpha/query/', 'ORPHA Auto-complete Endpoint', 'Endpoint that provides auto-complete service for ORPHA terms lookup ', 'endpoint', 'required'),
                                                                                                                               (25, 'snomed_autocomplete_url', 'https://autocomplete.cafevariome.org/Snomed/query/', 'SNOMED Auto-complete Endpoint', 'Endpoint that provides auto-complete service for SNOMED terms lookup ', 'endpoint', 'required'),
                                                                                                                               (26, 'gene_autocomplete_url', 'https://autocomplete.cafevariome.org/Gene/query/', 'Gene Auto-complete Endpoint', 'Endpoint that provides auto-complete service for gene lookup ', 'endpoint', 'required');
