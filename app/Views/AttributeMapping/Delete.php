...
<?php endif; ?>
<?php echo form_open($controllerName."/Delete/" . $attributeMappingId); ?>
<?php echo form_hidden(['attribute_mapping_id' => $attributeMappingId]); ?>
<div class="form-group">
	<span class="text-danger">Warning: Are you sure you want to delete '<?= $attributeMappingName; ?>'?</span>
</div>
<div class="form-group">
