...
<?php echo form_open($controllerName."/Discovery"); ?>
...
<div class="row mb-3">
    ...
    <div class="col-3">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" name="<?= $s->getID() ?>" id ="<?= $s->getID() ?>" <?= $s->value == 'on' ? 'checked' : '' ?>>
            <label class="form-check-label" for="<?=  $s->getID() ?>"></label>
            </div>
    </div>
    <?php else: ?>
    <div class="col-6">
