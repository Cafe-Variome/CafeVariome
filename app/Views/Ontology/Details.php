...
<div class="row mb-5">
	<div class="col">
		...
		<a href="<?= base_url($controllerName . '/Update') . "/" . $ontology['id']; ?>" class="btn btn-warning bg-gradient-warning">
			<i class="fa fa-edit"></i>&nbsp;Edit Ontology
		</a>
		<a href="<?= base_url($controllerName . '/Delete') . "/" . $ontology['id']; ?>" class="btn btn-danger bg-gradient-danger">
