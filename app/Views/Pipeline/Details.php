...
<div class="row mb-5">
	<div class="col">
		...
		<a href="<?= base_url($controllerName . '/Update') . "/" . $pipeline->getID(); ?>" class="btn btn-warning bg-gradient-warning">
			<i class="fa fa-edit"></i>&nbsp;Edit Pipeline
		</a>
		<a href="<?= base_url($controllerName . '/Delete') . "/" . $pipeline->getID(); ?>" class="btn btn-danger bg-gradient-danger">
