...
<div class="row">
	<div class="col pr-5 pl-5">
		<?php for($i = 0; $i < count($networks); $i++): ?>
			...
			<?php endif ?>
			<div class="col-3">
				<a class="btn btn-lg btn-info font-weight-bolder w-100" href="<?= base_url($controllerName . '/QueryBuilder/' . $networks[$i]->network_id ) ?>"><i class="fas fa-fw fa-network-wired"></i> <?= $networks[$i]->network_name ?></a>
				<br>
				<span class="text-info">Policy: </span><span class="text-muted"><?= $networks[$i]->policy ?></span>
			</div>
