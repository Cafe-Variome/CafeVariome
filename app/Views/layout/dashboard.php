    ...
    <div id="wrapper">
        ...
        <div id="content">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Mehdi Mehtarizadeh</span>
                    <img class="img-profile rounded-circle" src="img/mehdi.jpg" width="32" height="32">
                </a>
        ...
        <footer class="sticky-footer bg-white">
            ...
            <div class="copyright text-center my-auto">
                <span>Powered by Café Variome <br> Copyright &copy; <?= $heading . ' ' . date("Y"); ?> </span>
            </div>
            </div>
        </footer>
        <!-- End of Footer -->
