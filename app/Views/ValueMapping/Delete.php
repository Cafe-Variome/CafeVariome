...
<?php endif; ?>
<?php echo form_open($controllerName."/Delete/" . $valueMappingId); ?>
<?php echo form_hidden(['value_mapping_id' => $valueMappingId]); ?>
<div class="form-group">
	<span class="text-danger">Warning: Are you sure you want to delete '<?= $valueMappingName; ?>'?</span>
</div>
<div class="form-group">
