...
<?= form_open($controllerName."/Delete/" . $credential->getID()); ?>
<?= form_hidden(['id' => $credential->getID()]); ?>
<div class="form-group">
	<span class="text-danger">Warning: Are you sure you want to delete '<?= $credential->name; ?>'?</span>
</div>
<div class="form-group">
