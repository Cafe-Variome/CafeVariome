...
<table class="table table-bordered table-striped table-hover" id="networkstable">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="<?php echo base_url('network/edit_threshold' . '/' . $network->network_key . '/1') ?>" data-toggle="tooltip" data-placement="top" title="Edit Network Threshold">
					<span class="fa fa-tachometer-alt text-warning"></i>
				</a>
			<?php if (isset($groups[$network->network_name])): ?>
				<a href="<?php echo base_url('network/edit_user_network_groups' . '/' . $groups[$network->network_name] . '/1') ?>" data-toggle="tooltip" data-placement="top" title="Edit Users in Network">
			...
			<?php endif; ?>		
				<a href="<?php echo base_url('network/leave_network' . "/" . $network->network_key . "/" . $network->network_name); ?>" data-toggle="tooltip" data-placement="top" title="Leave Network">
