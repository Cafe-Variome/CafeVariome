...
<?= form_open($controllerName."/Delete/" . $proxyServer->getID()); ?>
<?= form_hidden(['id' => $proxyServer->getID()]); ?>
<div class="form-group">
	<span class="text-danger">Warning: Are you sure you want to delete '<?= $proxyServer->name; ?>'?</span>
</div>
<div class="form-group">
