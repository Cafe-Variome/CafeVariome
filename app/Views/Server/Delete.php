...
<?= form_open($controllerName."/Delete/" . $server->getID()); ?>
<?= form_hidden(['id' => $server->getID()]); ?>
<div class="form-group">
	<span class="text-danger">Warning: Are you sure you want to delete '<?= $server->name; ?>'?</span>
</div>
<div class="form-group">
