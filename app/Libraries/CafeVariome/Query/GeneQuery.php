...
class GeneQuery extends AbstractQuery
{
	...
	public function Execute(array $clause, Source $source)
	{
		...
		$neo_query = "MATCH (n:Pathway)<-[:PART_OF_PATHWAY*0..1]-(m:Reaction)-[:USING_GENE_PRODUCT*0..1]->(g:Gene)-[:HAS_EFFECT]->(p:Protein_Effect) WHERE (g.Symbol = '$gene_id')";
