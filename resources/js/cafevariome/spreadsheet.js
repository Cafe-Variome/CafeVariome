$("#uploadBulk").submit(function(event) {  
    ...
    validateParams = 'source_id=' + source_id + '&size=' + size + '&' + csrf_token_name + '=' + csrf_token;
    ...
    $.ajax({
        ...
        success: function(response)  {
            ...
            if (response == 'Locked') {
                ...
                uploadData.append('pipeline_id', pipeline_id);
...
$('#dataFile').on('change',function(){
    ...
    var selectedFileSize = $('#dataFile')[0].files[0].size;
