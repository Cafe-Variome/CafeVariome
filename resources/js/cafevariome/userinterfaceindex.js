...
function callUI(id) {
    ...
    $.ajax({
        url  : baseurl + 'AjaxApi/userInterfaceStart',
        type: 'POST',
        data : postData,
        dataType: 'json',
        success: function (data) {
            $.notify({
                // options
                message: 'User interface index is being generated.'
            },{
                // settings
                timer: 200
            });
...
$(document).ready(function() {
    var eventSource = new EventSource(baseurl + 'ServiceApi/pollUIIndex');
